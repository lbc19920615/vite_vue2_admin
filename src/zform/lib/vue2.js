...
var Interpreter = /* @__PURE__ */ function() {
  ...
  _proto2.createErrorMessage = function createErrorMessage(msg2, value, node) {
    var message = msg2[1].replace("%0", String(value));
    if (node !== null) {
  ...
  _proto2.createInternalThrowError = function createInternalThrowError(msg2, value, node) {
    return this.createError(this.createErrorMessage(msg2, value, node), msg2[2]);
  };
...
var ResizeObserver2 = ResizeObserver;
export {
