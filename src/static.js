...
const formDef = {type:'form',name:'form_iPxz_E',serviceTpl:{def:{},args:{src:'bservice.twig'}},def:{type:'object',ui:{},properties:{field__SZtgvBrSkQ:{type:'string',INIT_CONFIG:{type:'string'},ui:{widget:'CusInput',label:'多行文本',widgetConfig:{type:'textarea'}},computedFun:'',rules:[],server:{field_name:'field__SZtgvBrSkQ'},rules_json:'[]'},field__gvCEIm6WdQ:{type:'string',wrap:'z-grid-item',wrap_config:{},ui:{label:'单行文本',widgetConfig:{}},server:{field_name:'field__gvCEIm6WdQ'},wrap_start:'<z-grid>'},z_grid_column__blhZBJKr5t:{wrap:'z-grid-item',no_field:true,wrap_end:'</z-grid>'}},metas:{form_data:{tableName:'json_4e726',activeNo:'At202112274554'}}},computed:{}};
